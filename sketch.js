...
let frameCountBetweenObstaclesType2 = 50; // Adjust as needed
...
function draw() {
  ...
  frameCountBetweenObstaclesType1 = int(random(65, 70)); // Control frequency of Type 1 obstacles
  frameCountBetweenObstaclesType2 = int(random(120, 150)); // Control frequency of Type 2 obstacles
  ...
  let textY = counterY + counterHeight / 2.30;
